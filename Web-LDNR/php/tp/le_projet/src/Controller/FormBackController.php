...
class FormBackController extends AbstractController
{
  ...
  /**
   * @Route("/test_form_back", name="test_form_back")
   */
  public function index(Request $request): Response {
    ...
    try {
      ...
      if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->render('FormBack/index.html.twig', ['exception' => $excpt,
                                                          'errors' => $alert,
                                                          'nom' => $prs->getNom(),
    ...
    return $this->renderForm('FormSimple/index.html.twig', ['exception' => $excpt,
                                                            'errors' => $alert,
                                                            'form' => $form]);
  }
}