...
class DeptRegionController extends AbstractController
{
  ...
  public function fill(ManagerRegistry $doctrine, string $file): Response {
    ...
    return $this->render('DeptRegion/fill.html.twig', ['results' => $region_list,
                                                       'num_depts' => $num_depts,
                                                       'errors' => $alert]);
  }
  ...
  public function AfficheRegion(ManagerRegistry $doctrine, int $id): Response {
    ...
    return $this->render('DeptRegion/afficheRegion.html.twig', ['departements' => $dept_list,
                                                                'region' => $region,
                                                                'errors' => $alert]);
  }
}